...
bool sub_401352(int p0, int p4)
{
    ...
    auto * esi = new UnkClass3000(rect, 19, 0);
...
bool sub_4018E3()
{
    if (dword_53D584) {
        ...
        if (InputHandler::instance->getKeyboardHandler()->unk2() == DIK_F12) {
            dword_53D584 = false;
            InGame::unkGame111_instance->vtable8_registerForRedraw();
        }
...
LRESULT CALLBACK windowProcedure(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_ACTIVATEAPP: {
        ...
        if (globals_gameState == 0) {
            if (wParam == TRUE && MasterClass::instance != nullptr)
                MasterClass::instance->unkWndProc(true);
